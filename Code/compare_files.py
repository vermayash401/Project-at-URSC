...
ORIGINAL_FILE = "spacecraft_frames2.txt"
RECON_FILE = "recovered_original.txt"
...
if __name__ == "__main__":
    ...
    print(
        f"Sizes (bytes)     : {os.path.getsize(ORIGINAL_FILE):,} vs {os.path.getsize(RECON_FILE):,}"
    )
    ...
    if ok:
        print("RESULT: MATCH (normalized frame content identical)")
    else:
